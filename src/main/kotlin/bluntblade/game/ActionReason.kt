...
enum class ActionReason(val value: Int) {
    None(0),
    QuestItem(1),
    QuestReward(2),
    Trifle(3),
...
//    companion object {
//        private val map: Int2ObjectMap<ActionReason> = Int2ObjectOpenHashMap()
//        private val stringMap: MutableMap<String, ActionReason> = HashMap()
//
//        init {
//            Stream.of(*emu.grasscutter.game.props.ActionReason.values()).forEach(Consumer { e: ActionReason ->
//                map.put(e.value, e)
//                stringMap[e.name] = e
//            })
//        }
//
//        fun getTypeByValue(value: Int): ActionReason {
//            return map.getOrDefault(value, None)
//        }
//
//        fun getTypeByName(name: String): ActionReason {
